...
interface ComponentTransactionCardProps {
  title: string;
...
const ComponentTransactionCard: React.FC<ComponentTransactionCardProps> = ({
  title,
  children,
  className = "",
  desc = "",
...
const uniqueMethods = Array.from(
  new Set(alldata.map((item) => item.paymentType))
);
...
export default ComponentTransactionCard;
